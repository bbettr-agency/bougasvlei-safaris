...
/**
 * Project motion character — Bougasvlei Safaris is declared **editorial**
 * (unhurried, luxurious) per the Visual Direction Brief / PROJECT_STATUS.md.
 * This is the single per-project declaration; every preset, heroStack and
 * Stagger inherits it. Ease is unchanged — only duration and stagger.
 */
export const DEFAULT_CHARACTER: MotionCharacter = "editorial";
