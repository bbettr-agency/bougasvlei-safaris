...
export default function FloatingWhatsApp() {
  return (
    <a
      ...
      className="group fixed bottom-24 right-4 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_18px_40px_-12px_rgba(37,211,102,0.8)] transition-transform duration-200 hover:scale-105 active:scale-95 sm:bottom-6 lg:right-6"
    >
